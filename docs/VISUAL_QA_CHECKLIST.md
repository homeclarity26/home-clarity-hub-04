...
| 23 | Report Home | "Read by chapter" Cormorant title, section cards w/ page counts + Open buttons, "How this report stays alive" callout | ☐ |
| 24 | Room: Kitchen | Eyebrow SPACES · KITCHEN & PANTRY, metadata strip (18×22 · 396 sqft · 10ft · Floor 1), EXCELLENT dot, FINISHES 2-col grid, FIXTURES & POWER grid, OBSERVATIONS prose, "Not yet documented" italics, LINKED VISION PROJECT callout, CONCIERGE ACTION callout | ☐ |
| 25–26 | System: Furnace | FAIR dot + APPROACHING END-OF-LIFE pill, spec grid, lifecycle gradient bar (2009 → Today · 17 years → EOL ~2029), PROACTIVE LIFECYCLE ALERT amber callout, REPLACEMENT BRIEFING navy card w/ 3 tier cards | ☐ |
| 27–28 | Vision: Primary Bath | Navy hero w/ LIFESTYLE + YEAR 1-2 pills, THE VISION prose, WHY DESIGN MATTERS FIRST gold callout, INVESTMENT RANGES 3 tiers w/ RECOMMENDED pill, HOW WE EXECUTE navy callout (AKR disclosure) | ☐ |
| 29–30 | Recurring Services | H1 "Everything you're paying for, in one place", 3 stat cards ($1,918 / 20 / 9 overdue), navy HBC Concierge pitch card + gold CTA, vendor table w/ overdue rows flagged | ☐ |
| 31–32 | Strategy & Roadmap | "Your 10-Year Plan", Defense/Offense/Expansion cards w/ colored top borders, capital plan Gantt w/ phase cost footer | ☐ |
