...
const SEED_TEMPLATES = [
  ...
  { title: "Your Report Is Ready", category: "Report Ready", body_text: "Hi {{client_first_name}}, your Home Clarity Report for {{property_address}} has been published and is ready to view in your portal. Take a look at your condition ratings and Priority Action Items, and don't hesitate to message me with any questions. — {{advisor_name}}" },
