    ...
    async function loadTemplates() {
      try {
        ...
        if (loadedTemplates.length === 0) {
          ...
          loadedTemplates = [
            { id: "t-exec-summary", slug: "executive-summary", name: "Executive Summary", group_name: "information", sub_group: "overview", default_order: 1, icon: "FileText", block_config: {}, default_content: { narrative: "A comprehensive overview of your home's current condition, key findings, and recommended priorities.", condition_rating: "good" }, is_custom: false, version: 1, created_at: "", updated_at: "" },
            { id: "t-prop-overview", slug: "property-overview", name: "Property Overview", group_name: "information", sub_group: "overview", default_order: 2, icon: "Home", block_config: {}, default_content: { narrative: "Detailed property specifications, construction details, and general characteristics.", condition_rating: "good" }, is_custom: false, version: 1, created_at: "", updated_at: "" },
            { id: "t-roof", slug: "roof-system", name: "Roof System", group_name: "exterior", sub_group: "roof-envelope", default_order: 1, icon: "Shield", block_config: {}, default_content: { narrative: "Assessment of roofing materials, condition, and estimated remaining lifespan.", condition_rating: "fair", specs: { material: "Asphalt Shingle", age: "12 years", estimated_life: "20-25 years" }, tiers: [{ label: "Repair", cost: "$500-$1,500" }, { label: "Partial Replace", cost: "$3,000-$6,000" }, { label: "Full Replace", cost: "$8,000-$15,000" }] }, is_custom: false, version: 1, created_at: "", updated_at: "" },
            { id: "t-windows", slug: "windows", name: "Windows", group_name: "exterior", sub_group: "openings", default_order: 2, icon: "Square", block_config: {}, default_content: { narrative: "Window condition, energy efficiency, and operation assessment.", condition_rating: "fair" }, is_custom: false, version: 1, created_at: "", updated_at: "" },
            { id: "t-siding", slug: "siding", name: "Siding & Cladding", group_name: "exterior", sub_group: "cladding", default_order: 3, icon: "Layers", block_config: {}, default_content: { narrative: "Exterior cladding materials, condition, and maintenance needs.", condition_rating: "good" }, is_custom: false, version: 1, created_at: "", updated_at: "" },
            { id: "t-foundation", slug: "foundation", name: "Foundation", group_name: "exterior", sub_group: "structure", default_order: 4, icon: "Building", block_config: {}, default_content: { narrative: "Foundation type, condition, and any signs of settlement or water intrusion.", condition_rating: "good" }, is_custom: false, version: 1, created_at: "", updated_at: "" },
            { id: "t-garage", slug: "garage", name: "Garage", group_name: "exterior", sub_group: "structures", default_order: 5, icon: "Car", block_config: {}, default_content: { narrative: "Garage structure, door operation, and storage capacity.", condition_rating: "good" }, is_custom: false, version: 1, created_at: "", updated_at: "" },
            { id: "t-kitchen", slug: "kitchen", name: "Kitchen", group_name: "interior", sub_group: "kitchen-dining", default_order: 1, icon: "Utensils", block_config: {}, default_content: { narrative: "Kitchen layout, appliances, countertops, cabinetry, and overall functionality.", condition_rating: "fair", tiers: [{ label: "Refresh", cost: "$5,000-$10,000" }, { label: "Remodel", cost: "$25,000-$45,000" }, { label: "Full Gut", cost: "$50,000-$80,000" }] }, is_custom: false, version: 1, created_at: "", updated_at: "" },
            { id: "t-primary-bed", slug: "primary-bedroom", name: "Primary Bedroom", group_name: "interior", sub_group: "primary-suite", default_order: 2, icon: "Bed", block_config: {}, default_content: { narrative: "Primary bedroom size, condition, closet space, and comfort features.", condition_rating: "good" }, is_custom: false, version: 1, created_at: "", updated_at: "" },
            { id: "t-primary-bath", slug: "primary-bathroom", name: "Primary Bathroom", group_name: "interior", sub_group: "primary-suite", default_order: 3, icon: "Bath", block_config: {}, default_content: { narrative: "Primary bathroom fixtures, plumbing, ventilation, and finish condition.", condition_rating: "fair", tiers: [{ label: "Refresh", cost: "$3,000-$6,000" }, { label: "Remodel", cost: "$12,000-$20,000" }, { label: "Full Gut", cost: "$25,000-$40,000" }] }, is_custom: false, version: 1, created_at: "", updated_at: "" },
            { id: "t-basement", slug: "basement", name: "Basement", group_name: "interior", sub_group: "basement", default_order: 4, icon: "ArrowDown", block_config: {}, default_content: { narrative: "Basement condition, moisture levels, and finishing potential.", condition_rating: "fair", tiers: [{ label: "Waterproof", cost: "$3,000-$8,000" }, { label: "Partial Finish", cost: "$15,000-$25,000" }, { label: "Full Finish", cost: "$30,000-$50,000" }] }, is_custom: false, version: 1, created_at: "", updated_at: "" },
            { id: "t-living", slug: "living-room", name: "Living Room", group_name: "interior", sub_group: "living-spaces", default_order: 5, icon: "Sofa", block_config: {}, default_content: { narrative: "Living room layout, flooring, lighting, and overall condition.", condition_rating: "good" }, is_custom: false, version: 1, created_at: "", updated_at: "" },
            { id: "t-furnace", slug: "furnace", name: "Furnace / Heating", group_name: "systems", sub_group: "hvac", default_order: 1, icon: "Flame", block_config: {}, default_content: { narrative: "Heating system type, age, efficiency rating, and maintenance history.", condition_rating: "fair", specs: { type: "Gas Forced Air", brand: "Carrier", age: "14 years", efficiency: "80% AFUE" }, tiers: [{ label: "Service", cost: "$150-$300" }, { label: "Repair", cost: "$500-$2,000" }, { label: "Replace", cost: "$4,000-$8,000" }] }, is_custom: false, version: 1, created_at: "", updated_at: "" },
            { id: "t-ac", slug: "air-conditioning", name: "Air Conditioning", group_name: "systems", sub_group: "hvac", default_order: 2, icon: "Wind", block_config: {}, default_content: { narrative: "AC system type, capacity, age, and cooling performance.", condition_rating: "fair" }, is_custom: false, version: 1, created_at: "", updated_at: "" },
            { id: "t-water-heater", slug: "water-heater", name: "Water Heater", group_name: "systems", sub_group: "plumbing", default_order: 3, icon: "Droplets", block_config: {}, default_content: { narrative: "Water heater type, capacity, age, and condition assessment.", condition_rating: "good" }, is_custom: false, version: 1, created_at: "", updated_at: "" },
            { id: "t-electrical", slug: "electrical-panel", name: "Electrical Panel", group_name: "systems", sub_group: "electrical", default_order: 4, icon: "Zap", block_config: {}, default_content: { narrative: "Main panel capacity, breaker condition, grounding, and code compliance.", condition_rating: "good" }, is_custom: false, version: 1, created_at: "", updated_at: "" },
            ...
            { id: "t-laundry", slug: "laundry", name: "Laundry Room", group_name: "interior", sub_group: "utility", default_order: 6, icon: "Shirt", block_config: {}, default_content: { narrative: "Laundry room layout, hookups, ventilation, and condition.", condition_rating: "good" }, is_custom: false, version: 1, created_at: "", updated_at: "" },
          ] as any;
        }
        // ────────────────────────────────────────────────────────────
