...
import { ArrowLeft, ExternalLink, Plus, Calendar, DollarSign, Briefcase } from "lucide-react";
...
import { mockClients, mockProjects, mockInvoices } from "@/data/adminMockData";
  ...
  return (
    <div>
      ...
      <div className="p-6 max-w-7xl space-y-6">
        ...
        {activeTab === "report" && <ReportPageManager propertyId={client.propertyId} />}
              ...
              <TableBody>
                {mockProjects.map((project) => (
                  <TableRow key={project.id}>
                    ...
                    <TableCell>
                      <Badge className={`${statusStyles[project.status]} text-[11px] font-sans border-none capitalize`}>
              ...
              <TableBody>
                {mockInvoices.map((invoice) => (
                  <TableRow key={invoice.id}>
                    ...
                    <TableCell>
                      <Badge className={`${invoiceStatusStyles[invoice.status]} text-[11px] font-sans border-none capitalize`}>
                        {invoice.status}
                      </Badge>
                    </TableCell>
                  </TableRow>
          ...
          <div className="space-y-4">
            ...
            <Card className="p-6 text-center">
              ...
              <p className="text-xs font-sans text-muted-foreground">
                Schedule appointments, set maintenance reminders, and sync with your calendar.
              </p>
            </Card>
            <Card className="p-5">
