...
export const reportGroups = [
  ...
  },
  {
    ...
    pages: ["refrigerator", "range-oven", "microwave", "dishwasher", "garbage-disposal", "washer-dryer", "range-hood"],
  },
  {
    id: "exterior-structures",
    title: "Exterior Structures",
    pages: ["fence-gate", "shed-outbuilding", "outdoor-lighting", "irrigation-sprinklers", "pool-spa"],
  },
  {
    id: "interior-additional",
    title: "Additional Spaces",
    pages: ["sunroom-screened-porch", "media-room", "crawlspace", "workshop"],
  },
  {
    id: "systems-additional",
    title: "Additional Systems",
    pages: ["ductwork-ventilation", "thermostat-smart-home", "water-softener-filtration", "sump-pump", "septic-well", "solar-panels"],
  },
  {
    id: "safety-detection",
    title: "Safety & Detection",
    pages: ["smoke-co-detectors", "security-system", "fire-extinguishers", "radon-mitigation"],
  },
  {
    id: "strategy",
    title: "Strategy",
...
export const reportPages: Record<string, ReportPageData> = {
  ...
  "refrigerator": {
    ...
    narrative: [],
    specs: [],
    tiers: { essential: { price: "", description: "" }, enhanced: { price: "", description: "" }, signature: { price: "", description: "" } },
    timing: "",
    recommendations: [],
  },
  "range-oven": {
  ...
  "sunroom-screened-porch": {
    id: "sunroom-screened-porch",
    title: "Sunroom / Screened Porch",
    group: "interior-additional",
    narrative: [],
    specs: [],
    tiers: { essential: { price: "", description: "" }, enhanced: { price: "", description: "" }, signature: { price: "", description: "" } },
    timing: "",
