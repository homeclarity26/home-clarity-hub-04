...
export const clientPhotosDocuments: Tutorial[] = [
  ...
  },
  {
    ...
    tip: "You can also use the AI Home Concierge to look up details about your equipment before requesting service — just ask 'What brand is my furnace?' or 'When was my AC last serviced?'",
